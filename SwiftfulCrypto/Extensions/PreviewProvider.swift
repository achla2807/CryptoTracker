...
class DeveloperPreview{
    ...
    let stat1 = StatisticModel(title: "Market Cap", value: "$14", percentageChange: 25.34)
    let stat2 = StatisticModel(title: "Total Volume", value: "$1.23t")
    let stat3 = StatisticModel(title: "Portfolio Value", value: "$12.2", percentageChange: -12.12)
