...
//  SwiftfulCrypto
//
//  Created by Achla Ajay on 28/04/25.
//
...
class HomeViewModel: ObservableObject{
    ...
    private func mapGlobalMarketData(marketDataModel: MarketDataModel?, portfolioCoins: [CoinModel]) -> [StatisticModel] {
        ...
        let marketCap = StatisticModel(title: "MarketCap", value: data.marketCap, percentageChange: data.marketCapChangePercentage24Usd)
